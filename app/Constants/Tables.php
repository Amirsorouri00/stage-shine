...
{
    const STAGESHINE_USERS = 'users';
    const STAGESHINE_JOBS = 'subscription_jobs';
    const STAGESHINE_EVENTS = 'events';
    ...
    const STAGESHINE_USER_ARCHIVED_EVENTS = 'user_archived_events';
}
